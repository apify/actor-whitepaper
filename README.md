...
- [The Web Actor Programming Model Whitepaper \[DRAFT\]](#the-web-actor-programming-model-whitepaper-draft)
  ...
  - [Basic concepts](#basic-concepts)
    - [Input](#input)
      - [Example of auto-generated Actor input UI](#example-of-auto-generated-actor-input-ui)
  ...
  - [Actor programming interface](#actor-programming-interface)
    ...
    - [Charging money](#charging-money)
      - [Node.js](#nodejs-16)
      - [Rules for building Actors with variable charging](#rules-for-building-actors-with-variable-charging)
  - [Actor definition files](#actor-definition-files)
    - [Actor file](#actor-file)
      - [Example Actor file at `.actor/actor.json`](#example-actor-file-at-actoractorjson)
    - [Dockerfile](#dockerfile)
      - [Example Dockerfile of an Actor](#example-dockerfile-of-an-actor)
    - [README](#readme)
